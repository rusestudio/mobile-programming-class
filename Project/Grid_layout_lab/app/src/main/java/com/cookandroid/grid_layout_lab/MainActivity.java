package com.cookandroid.grid_layout_lab;
                ...
                public void onClick(View v) {
                    if (edit1.isFocused() == true) {
                        ...
                        Toast.makeText(getApplicationContext(),
                                "select input box first", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
...
//isFocused to make cursor focus on which edit input.
//if does not click on edit input will have toast msg.